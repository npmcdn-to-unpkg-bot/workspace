...
var styleCache_ZAF_roads={}
var style_ZAF_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ZAF_roads[key]){
        ...
        styleCache_ZAF_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ZAF_roads[key]];
