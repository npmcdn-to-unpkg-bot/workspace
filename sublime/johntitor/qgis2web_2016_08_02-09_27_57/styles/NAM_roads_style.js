...
var styleCache_NAM_roads={}
var style_NAM_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_NAM_roads[key]){
        ...
        styleCache_NAM_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_NAM_roads[key]];
