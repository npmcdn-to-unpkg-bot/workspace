...
var styleCache_ZMB_roads={}
var style_ZMB_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ZMB_roads[key]){
        ...
        styleCache_ZMB_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ZMB_roads[key]];
