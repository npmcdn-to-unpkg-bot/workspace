...
var styleCache_MOZ_roads={}
var style_MOZ_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_MOZ_roads[key]){
        ...
        styleCache_MOZ_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_MOZ_roads[key]];
