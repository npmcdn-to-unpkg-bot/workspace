...
var styleCache_AGO_roads={}
var style_AGO_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_AGO_roads[key]){
        ...
        styleCache_AGO_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_AGO_roads[key]];
