...
var styleCache_ZWE_roads={}
var style_ZWE_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_ZWE_roads[key]){
        ...
        styleCache_ZWE_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ZWE_roads[key]];
