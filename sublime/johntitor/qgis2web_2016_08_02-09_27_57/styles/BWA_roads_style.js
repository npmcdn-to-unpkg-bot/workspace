...
var styleCache_BWA_roads={}
var style_BWA_roads = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_BWA_roads[key]){
        ...
        styleCache_BWA_roads[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_BWA_roads[key]];
